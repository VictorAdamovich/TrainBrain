...
let topStudents = deepCopyStudents.filter(el => el.scores >= 100).splice(0, 3)
...
let bestStudent = deepCopyStudents.reduce((acc, val) => acc.scores > val.scores ? acc : val)
...
let scoresSum2 = deepCopyStudents.reduce((acc, val) => acc + val.scores, 0)
